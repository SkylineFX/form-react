export default function Thanks() {
  return (
    <div className="bg-white rounded-xl px-6 py-16 flex flex-col gap-5 shadow-md items-center absolute right-4 left-4 -top-[76px]">
      <div>
        <img className="w-16 aspect-square" src="/src/assets/images/icon-thank-you.svg" alt="" />
      </div>
